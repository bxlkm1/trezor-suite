...
const OuterCircle = styled.div<{ isSelected?: boolean; isMobile?: boolean }>`
    ...
    background: ${props => props.theme.NEUE_BG_WHITE};
    border-radius: 50%;
    border: 2px solid ${props => (props.isSelected ? props.theme.NEUE_BG_GREEN : 'transparent')};
    transition: all 0.3;
    cursor: pointer;
...
const StyledInput = styled(Input)`
    && {
        background-color: ${props => props.theme.NEUE_BG_GREY_ALT};
        border: none;
    }
`;
        ...
        <Wrapper>
            <InputWrapper showCoinFilter={showCoinFilter}>
                <StyledInput
                    ...
                    innerAddon={
                        <SearchIconWrapper>
                            <Icon icon="SEARCH" size={16} color={theme.NEUE_TYPE_DARK_GREY} />
                        </SearchIconWrapper>
                    }
                    addonAlign="left"
                    textIndent={[16, 12]}
