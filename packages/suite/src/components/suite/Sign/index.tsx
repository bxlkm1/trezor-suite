...
const Sign = ({
    ...
    const defaultColor = grayscaleColor ?? theme.NEUE_TYPE_DARK_GREY;
    ...
    if (isValuePos) {
        return <StyledSign color={grayscale ? defaultColor : theme.NEUE_TYPE_GREEN}>+</StyledSign>;
    }

    if (!isValuePos && showMinusSign) {
        return <StyledSign color={grayscale ? defaultColor : theme.NEUE_TYPE_RED}>–</StyledSign>;
    }
    return null;
};
