...
const TabButton = styled.button<{ selected: boolean }>`
    ...
    color: ${props =>
        props.selected ? `${props.theme.NEUE_TYPE_GREEN}` : `${props.theme.NEUE_TYPE_LIGHT_GREY}`};
    border-bottom: ${props => (props.selected ? `2px solid ${props.theme.NEUE_BG_GREEN}` : 'none')};
`;
