...
import { Icon, useTheme, variables, Link, Loader } from '@trezor/components';
...
const ConfirmationStatus = styled.div<{ confirmed: boolean }>`
    color: ${props =>
        props.confirmed ? props.theme.NEUE_TYPE_GREEN : props.theme.NEUE_TYPE_ORANGE};
                ...
                <MainIconWrapper>
                    ...
                    {!isFetching && (
                        <NestedIconWrapper>
                            <Icon
                                size={12}
                                color={isConfirmed ? theme.NEUE_BG_GREEN : theme.NEUE_TYPE_ORANGE}
