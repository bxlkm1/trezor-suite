...
const getIconColor = (variant: ButtonVariant, isDisabled: boolean, theme: SuiteThemeColors) => {
    if (isDisabled) return theme.NEUE_TYPE_LIGHT_GREY;

    switch (variant) {
        case 'primary':
        case 'danger':
            return theme.NEUE_TYPE_WHITE;
        case 'tertiary':
            return theme.NEUE_TYPE_DARK_GREY;
        case 'secondary':
            return theme.NEUE_TYPE_GREEN;
        // no default
    }
};
...
const Wrapper = styled.button<WrapperProps>`
    ...
    ${props =>
        ...
        css`
            ...
            background: ${props => props.theme.NEUE_BG_GREEN};

            &:hover,
            &:focus,
            &:active {
                /* we use this color only for this case  */
                background: ${props => props.theme.NEUE_BG_GREEN_HOVER};
            }
        `}
    ...
    ${props =>
        ...
        css`
            background: ${props => props.theme.NEUE_BG_LIGHT_GREEN};
            font-weight: ${variables.FONT_WEIGHT.MEDIUM};
            ...
            &:active {
                /* we use this color only for this case  */
                background: ${props => props.theme.NEUE_BG_LIGHT_GREEN_HOVER};
            }
        `}
    ...
    ${props =>
        ...
        css`
            ...
            background: ${props => props.theme.NEUE_BG_GREY_ALT};
