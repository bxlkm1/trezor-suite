...
const StyledLoader = styled.div<{ size: number; strokeWidth: number }>`
    position: relative;
    text-indent: -9999em;
    border-top: ${props => `${props.strokeWidth}px`} solid ${props => props.theme.NEUE_TYPE_GREEN};
    border-right: ${props => `${props.strokeWidth}px`} solid ${props => props.theme.NEUE_TYPE_GREEN};
    border-bottom: ${props => `${props.strokeWidth}px`} solid
        ${props => props.theme.NEUE_TYPE_GREEN};
